    -- Fix get_feed_for_user function to return video_url column
    -- This replaces the existing function with one that includes video_url
    ...
    BEGIN
        ...
        SELECT
            ...
            p.content,
            p.image_url,
            p.video_url,  -- This is the key fix - including video_url
            p.gif_url,
            p.sticker_url,
            p.post_type,
            p.metadata,
    ...
    -- Add comment
    COMMENT ON FUNCTION public.get_feed_for_user IS 'Returns posts for user feed with video_url included';