-- Create function to get latest chat message
create or replace function get_latest_chat_message(p_chat_id uuid)
returns table (
    message_id uuid,
    content text,
    sender_id uuid,
...
-- Enhanced function to fetch recent chats with reliable last message
